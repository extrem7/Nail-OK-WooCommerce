<?php do_action( 'woocommerce_before_checkout_billing_form', $checkout ); ?>
    ...
    <div class="row justify-content-between">
        <div class="col-md-6">
            ...
            <input type="text" class="input-text input" name="billing_city" id="billing_city" placeholder="Ярославль"
                   value="<?= $checkout->get_value( 'billing_city' ) ?>"
                   autocomplete="<?= $fields['billing_city']['autocomplete'] ?>">
            <input type="text" class="input-text input" name="billing_address_1" id="billing_address_1"
                   ...
                   autocomplete="<?= $fields['billing_address_1']['autocomplete'] ?>">
            ...
            <div class="address-details">
                <input type="text" class="input-text input" name="billing_address_2" id="billing_address_2"
                       ...
                       autocomplete="<?= $fields['billing_address_2']['autocomplete'] ?>">
        ...
        <div class="col-md-6">
            ...
            <input type="text" class="input-text input" name="billing_first_name" id="billing_first_name"
                   ...
                   autocomplete="<?= $fields['billing_first_name']['autocomplete'] ?>">
		...
		foreach ( $fields as $key => $field ) {
			...
			if ( $key != 'billing_city' && $key != 'billing_address_1' && $key != 'billing_country' && $key != 'politics'
        ...
        <div class="checkbox">
            ...
            <p>С <a href="<? the_field( 'политика' ) ?>">политикой конфиденциальности</a> согласен</p>
        </div>
    </div>
